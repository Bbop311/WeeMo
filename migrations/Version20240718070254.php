 ...
 */
final class Version20240718070254 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(' DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE property (iCREATE TABLE listing (id INT AUTO_INCREMENT NOT NULL, property_id INT DEFAULT NULL, listing_title VARCHAR(255) NOT NULL, listing_description LONGTEXT NOT NULL, start_date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', end_date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', status VARCHAR(20) NOT NULL, INDEX IDX_CB0048D4549213EC (property_id), PRIMARY KEY(id))d INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, date_mutation VARCHAR(255) DEFAULT NULL, nature_mutation VARCHAR(255) DEFAULT NULL, valeur_fonciere INT DEFAULT NULL, no_voie VARCHAR(255) DEFAULT NULL, b_t_q VARCHAR(255) DEFAULT NULL, type_voie VARCHAR(255) DEFAULT NULL, code_voie VARCHAR(255) DEFAULT NULL, voie VARCHAR(255) DEFAULT NULL, code_postal VARCHAR(255) DEFAULT NULL, commune VARCHAR(255) DEFAULT NULL, code_departement VARCHAR(255) DEFAULT NULL, code_commune VARCHAR(255) DEFAULT NULL, section VARCHAR(255) DEFAULT NULL, nb_lots INT DEFAULT NULL, code_type_local VARCHAR(255) DEFAULT NULL, type_local VARCHAR(255) DEFAULT NULL, surface_reelle_bati INT DEFAULT NULL, nb_pieces INT DEFAULT NULL, surface_terrain INT DEFAULT NULL, INDEX IDX_8BF21CDEA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
